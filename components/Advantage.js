    ...
    <div className="bg-gray-100">
        <section className="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-white pt-16">
            <div className="flex items-center flex-col px-4">
                <h1  className="focus:outline-none text-4xl lg:text-4xl font-extrabold text-center leading-10  lg:w-5/12 md:w-9/12 pt-4">مميزات الموقع</h1>
                <p  className="focus:outline-none text-sm text-center mt-3  leading-4 font-mono">mansour_tech@</p>
            </div>
            <div className="focus:outline-none mt-20 flex flex-wrap justify-start gap-10 px-4">
                <div className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    <div className="w-20 h-20 relative mr-5">
                        <div className="absolute top-0 right-0  rounded w-16 h-16 mt-2 mr-1"></div>
                    ...
                    <div className="w-10/12 mr-10">
                        <h2  className="focus:outline-none text-lg font-bold leading-tight ">سريع</h2>
                ...
                <div className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12 mr-10">
                        <h2  className="focus:outline-none text-lg font-semibold leading-tight ">بدون إعلانات</h2>
                ...
                <div  className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12 mr-10">
                        <h2  className="focus:outline-none text-lg font-semibold leading-tight ">صور عالية الدقة</h2>
                ...
                <div className="focus:outline-none flex sm:w-full md:w-5/12 pb-20">
                    ...
                    <div className="w-10/12 mr-10">
                        <h2  className="focus:outline-none text-lg font-semibold leading-tight ">ريل تايم</h2>
